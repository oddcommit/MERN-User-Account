...
export default function Navbar() {
  ...
  return (
    <div className="bg-white relative w-full border-b-sky-900 border-b-2 z-100">
        ...
        <div className="flex justify-between ">
          <div className="flex flex-row">
            ...
            {auth.isAuthenticated && (
              <Link to="/blog" className=" font-normal text-2xl leading-6 text-blue-800 ms-6 mt-1">
                Blog
              </Link>
            )}
          </div>
          ...
          <div className="hidden sm:flex flex-row space-x-4">
            {auth.isAuthenticated ? (
              <>
                <p  className=" font-normal text-lg leading-6 text-grey-800 ms-6 mt-2">{auth.user.name}</p>
                <button
                  onClick={_logout}
